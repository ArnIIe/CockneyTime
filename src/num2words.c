...
static const char* STR_OH_CLOCK = "oh tick tock";
static const char* STR_NOON = "spoon";
static const char* STR_MIDNIGHT = "what a sight";
static const char* STR_QUARTER = "farmers daughter";
